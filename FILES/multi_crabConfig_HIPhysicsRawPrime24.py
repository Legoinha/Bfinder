...
config.General.workArea = 'crab_projects_B24'
...
config.JobType.maxMemoryMB = 2000         # request high memory machines. start w/ 2k then go higher if needed!
...
# Submit the jobs: 163 HIRawPrime24 PDs, ~350 files each, average of ??? events/file
config.Data.outLFNDirBase = '/store/user/hmarques/DATA_PbPb24/Bmesons'
